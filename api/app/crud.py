...
# ---------- Bills & Lines ----------
def create_bill(db: Session, bill_type: str, party_name: Optional[str], bill_no: str,
                bill_date: str, source: str, status: str, uploaded_doc: str,
    ...
    bill = models.Bill(
        bill_type=bill_type,
        party_name=party_name,   # keep legacy text for now
        vendor_id=vendor_id,     # new relation
        bill_no=bill_no,
        bill_date=bill_date,
        source=source,
        status=status,
